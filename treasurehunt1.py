...
def drawBoard(board):
    ...
    for row in range(15):
        ...
        # Create the string for this row on the baord.
        boardRow = ''
...
def makeMove(board, chests, x, y):
    ...
    # Return Falise if this is an invalid move.
...
so it shwos an X. The treasure chests do not move around. Sonar devices can
detect treasure chests up to a distance of 9 spaces. Try to collect all 3
chests before running out of sonar devices. Good luck!
Press enter to continue...''')
    input()
...
while True:
    ...
    if sonarDevices == 0:
        print('We\'ve run out of sonar devices! Now we ahve to turn the ship around and head')
